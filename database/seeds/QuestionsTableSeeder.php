...
class QuestionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach( $file as $line ){
            ...
            $genreName = mb_convert_encoding($line[2], 'UTF-8', 'SJIS');
            $levelName = mb_convert_encoding($line[3], 'UTF-8', 'SJIS');
        ...
        // テストデータ
        // $genres = ['学校/全体', '学校/先生', '学校/生徒', '勉学/授業', '勉学/PC基礎', '勉学/国家試験', '勉学/プログラミング'];
        // $levels = ['共通', 'IT共通', 'IT下級', 'IT上級', 'GM共通', 'GM下級', 'GM上級'];
